...
- 2019.6 - 2019.7　イプソス株式会社（中国）：①Python クローラーを使用して Instagram 上の写真をダウンロードし、画像の内容に基づいてデータに注釈を付ける。②エクスポートされた同社のオンラインショップの購入レビューをもとに、肯定的な感情と否定的な感情を分類する。
このデータは最終的に機械学習の学習や市場調査などに応用される予定です。

## 自己PR

### 自分の長所

①複合領域：データマイニングを中心に、経営や経済などの基礎知識を補った学部での研究。 異なる分野の知識を理解する能力。

②高い情報処理能力：クローラーやデータベースなど、オフィスオートメーションの手法を何度も使ったことがある。 仕事や勉強を効率的にする。

③計画性：私の強みは、計画性を持っていることです。学部学生会で、私は複数の部門を担当しました。 そのため、仕事の優先順位の付け方や、賢くスケジュールを組み立てる方法を学びました。


### 知識

①ビジネス知識：データから価値ある情報を抽出し、モデルの目的がビジネス価値を生み出すことだと理解する能力。

②モデル・アルゴリズム理解：解析モデルの出力を解釈するための統計的確率の基礎知識を有する。 さまざまな伝統的なアルゴリズムの導出を理解し、さまざまなシナリオに対する古典的な解決策を理解することができる。

③プログラミングの知識：データの取得、処理、解析のためにPythonを使用できること。 Sklearnなど特定のアルゴリズムに対応したツールキットの知識。 
