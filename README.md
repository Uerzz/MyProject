...
| 年月      | 学歴                                                         |
| --------- | ------------------------------------------------------------ |
| 2014年9月 | 内モンゴル　第五高等学校　入学                               |
| 2017年6月 | 内モンゴル　第五高等学校　卒業                               |
| 2017年9月 | 四川　電子科技大学　公共管理学部　情報管理と情報システム専攻　入学 |
| 2021年6月 | 四川　電子科技大学　公共管理学部　情報管理と情報システム専攻　卒業 |
| 2021年9月 | 早稲田大学北九州キャンパス　情報生産システム研究科（英語授業）　入学 |
| 2023年6月 | 早稲田大学北九州キャンパス　情報生産システム研究科（英語授業）　卒業見込み |

## インテンシブ

- 2019.7－2019.9　中国電建集団成都院勘測設計研究院：HR 管理情報システム最適化の仕事をした。適切なサプライヤーを選択し、HR 管理情報システム の不備に対して提案することにより、余計な人件費の発生を回避し、採用費用と時間を削減し、人 事・労務管理を最適化し、従って人件費を削減する目的を達っする。システムの分析と設計をある 程度身につけたとともに、 需要分析の確立のために UML モデリングを学習した。
- 2019.6 - 2019.7　イプソス株式会社（中国）：画像はInstagramのウェブクローラーでダウンロードし、画像の内容に応じてデータをラベリングしました。データは全て最終的に機械学習の学習や市場調査に応用する予定です。

## 自己PR

私の長所は、最後まであきらめないことです。私はこれまで、生徒会の部長、サークル活動のリーダーなど、責任のある役割を多く経験してきました。いずれも、途中で投げ出すことなく最後まで務めました。

学部では新年コンサートの実行委員会に所属していました。そのときはちょうど学業でも忙しい時期で、両立するのが体力的にも精神的にも大変でした。つらさに耐えかね、実際に辞めていくメンバーもいる中、わたしはリーダーとして最後まで力を抜かず、イベントを成功させることができました。

入社後でも、最後まであきらめることなく何事にもチャレンジし続け、どんな高い壁にぶつかっても諦めず常に物事の改善に努めたいと思います。

## 学生時代に力を入れたこと

私が頑張ったのは、学生会の役員を3年間継続したことです。

私が学生会を選んだのは、他の学生たちの役に立つことが好きだったからです。しかし、私の仕事では、皆に納得してもらえないことがわかりました。失敗が多く、落ち込むことや学生会を辞めたいと思うこともしばしばあったのですが、先輩の仕事ぶりと比べてみると、皆の満足度を高めるような、学生中心のサービスが不足していることに気がつきました。

そのため、最近困っていることや解決しなければならない問題を聞くなど、学生とのコミュニケーションを積極的に行いました。その結果、笑顔でお礼を言ってもらうことが多くなり、皆に満足してもらう喜びを感じながら学生会を継続することができました。

学生会活動を通じて、相手の気持ちを汲み取って行動するということを学びました。貴社でもこの学びを活かし、より良い環境を作り上げたいと思います。

## ゼミ研究

手話は、聴覚または言語障害者が他者とコミュニケーションをするために使う言語です。 しかし、多くの人が手話を知らないことが、彼らの日常生活に大きく影響している。

本研究ではでは、手のキーポイントアルゴリズムにより、連続的な手のデータを抽出する。そして、動きによって分割される。最後に、分割されたデータを自然言語処理モデルに入力し、手話の翻訳を出力する。

この研究により、より迅速かつ正確な手話認識を実現することができる。聴覚または言語障害者の日常生活を便利にするとともに、手話の普及を促進することができます。

## 資格

- 2020年1月　日本語能力試験　N1合格
- 2020年11月　TOEIC　830点
- 2019年8月　Microsoft Office Specialist Master

## スキル

【言語】Python
【用途】授業・研究・インターン
【詳細】Pythonの基本文法をマスターし、コンピュータを使って実用的な問題を解決するための解法をマスターする。生活や仕事における実践的な問題を解決するための実践的なPythonを習得する。

                Pythonを使って、機械学習の基本問題（分類、クラスタリング、回帰、次元削減）を紹介することで、一般的な問題を解決するための機械学習アルゴリズムを習得し、機械学習を理解し、古典的アルゴリズムを導入する。
               学校でデータクリーニング、データ前処理、データマイニングのためにpythonを使用する。
               卒業設計でpythonを使用してニューラルネットワークを構築し、課題要件に応じたデータ予測を行う。
               Pythonを使ってウェブデータをクロール、キー情報を抽出し、イプソスインターンでのデータラベリング効率を向上させます。

【言語】Java
【用途】練習
【詳細】アルゴリズムやデータ構造を学ぶ際の練習用としてJavaを使用しました。(2か月)

【言語】C/C++/Ruby/MySQL
【用途】授業
【詳細】学校で勉強し、履修条件をクリアした。(半年)
...
Image Collection, annotation and Sentiment Classification	2019.6-2019.7
